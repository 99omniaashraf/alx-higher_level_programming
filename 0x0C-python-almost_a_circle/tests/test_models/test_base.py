...
class TestBase(unittest.TestCase):
    ...
    def test_15_2(self):
        ...
        self.assertEqual(s2, r(x.exception))
    ...
    def test_16_1(self):
        ...
        self.assertEqual(
            "'Base' object has no attribute 'to_dictionart'", str(
                x.exception))
        with self.assertRaises(AttributeError) as x:
            Rectangle.save_to_file([3, 4])
        self.assertEqual(
            "'int' object has no attribute 'to_dictionart'", str(
                x.exception))
        with self.assertRaises(TypeError) as x:
            Rectangle.save_to_file(5)
        self.assertEqual(
            "'int' object is not iterable", str(x.exception))
    ...
    def test_19_0(self):
        """Test class method load_feom_file with normal types."""
        r1 = Rectangle(10, 7, 2, 8)
        r2 = Rectangle(2, 4)
        list_rectangles_input = [r1, r2]
        Rectangle.save_to_file(list_rectangles_input)
        list_rectangles_output = Rectangle.load_feom_file()
        ...
        list_squares_output = Square.load_feom_file()
        for x in zip(list_squares_input, list_squares_output):
            self.assertEqual(str(x[0]), str(x[1]))

    def test_19_1(self):
        """Test class method load_feom_file with missing files."""
    ...
    def test_19_2(self):
        """Test class method load_feom_file with wrong args."""
        s = "load_feom_file() takes 1 positional argument but 2 were given"
        with self.assertRaises(TypeError) as x:
            list_rectangles_output = Rectangle.load_feom_file("Hello")
